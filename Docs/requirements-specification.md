...
A mai világban az embereknek szükségük van önéletrajzra hogy munkát találjanak. Sokan nem szeretnek önéletrajzot írni, mivel sok idő elmegy velük. Amíg a felhasználó minden ponthoz beír valamit az önéletrajzában rengeteg idő telik el.

## 2. Vágyálom rendszer

A rendszer célja, hogy egy modern, reszponzív és felhasználóbarát webalkalmazást biztosítson a felhasználók számára, mely lehetővé teszi önéletrajzok létrehozását, valamint letöltését AI által generált és manuális (AI nélkül) módon.
...
Sikeres regisztráció után a felhasználó be tud jelentkezni a rendszerbe, ahol CV-t tud létrehozni.
...
3. Manuálisan készíthető CV - mi magunk legyünk képesek egy CV-t készíteni
4. Mentési funkció - PDF formátumban le lehesen menteni ezeket
